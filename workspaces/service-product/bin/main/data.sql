...
INSERT INTO tbl_usuarios (id, username, apellido, email)
VALUES (1, 'Edilson', 'Arias', 'edilsonarias@gmail.com');

INSERT INTO tbl_usuarios (id, username, apellido, email)
VALUES (2, 'Camilo', 'vargas', 'camilopo56@gmail.com');

INSERT INTO tbl_usuarios (id, username, apellido, email)
VALUES (3, 'Cristian Camilo', 'Yepez', 'yepex@gmail.com');